...
export default function SignupPage() {
  ...
  const errors = {
    ...
    password:
      touched.password &&
      (!formData.password ? 'Password is required' : formData.password.length < 6)
      ...
      <div className={styles.container}>
        <div className={styles.signupCard}>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            {/* Name Input */}
            <div
              className={`${styles.inputGroup} ${errors.name ? styles.inputGroupError : touched.name ? styles.inputGroupSuccess : ''}`}
            >
            ...
            {/* Email Input */}
            <div
              className={`${styles.inputGroup} ${errors.email ? styles.inputGroupError : touched.email ? styles.inputGroupSuccess : ''}`}
            >
            ...
            {/* Password Input */}
            <div
              className={`${styles.inputGroup} ${errors.password ? styles.inputGroupError : touched.password ? styles.inputGroupSuccess : ''}`}
            >
